  ...
  public static void readFromCsvFileAndWriteToExistingTable(
    ...
    try {
      ...
      throw new RuntimeException(
          "Error performing insert in table " + tableName + " at line: " + lineNumber.get(), e);
    }
  }
  ...
  public static class Database {
    ...
    private static final Set<String> DB_WHITELIST =
        HashSet.of(
            ...
            "cdbl_eds_jenkins_chrg_app.worldpaytd.local");
    ...
    private void setup(String... tables) {
      ...
      // connection.execQuery("refresh vw_bcu_account", "{call
      // CBE_CUE_OWNER.PKG_CHARGING_ENGINE.prc_refresh_billing_account()}",
